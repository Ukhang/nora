...
export function Navbar() {
  return (
    <nav className="w-full h-14 sticky top-0 z-50 lg:px-4 backdrop-filter backdrop-blur-xl bg-opacity-5 sm:backdrop-none sm:backdrop-blur-none sm:bg-opacity-none">
